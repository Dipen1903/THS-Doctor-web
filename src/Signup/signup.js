...
export default function SignUp(){
  ...
  useEffect(()=>{
	...
	return(
    <>
    <MyModal show={modalShow} onHide={(e) => {
      setModalShow(false)
                        ...
                        <Form>
                          ...
                          <div class="row">
                            <div class="col-md-12 mt_20">
                              ...
                              <div class="input_box">
                                <div class="form_group">
                                  <input type="text" name="mobilenum" placeholder="" required/>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-12 mt_20">
                              ...
                              <div class="input_box">
                                <div class="form_group">
                                  <input type="email" name="mobilenum" placeholder="" required/>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-12 mt_20">    
                            ...
                            <div class="col-md-12 mt_20">                              
                              <label className="sign_title">Confirm Password </label>
                              <div class="input_box">
                                <div class="form_group">
                                  <input type="password" id="password" name="password" placeholder="" required />
                            ...
                            <div class="col-md-12">
                              <button class="login_btn" variant="primary" onClick={()=>setModalShow(true)}>Sign Up</button>
                            </div>
                          </div>
                        </Form>
                        <div class="row mt_20">
                        	<div class="col-md-12">
                        		<h3 class="by_clicking">By clicking sign up you are agreeing to the<br/> <Link to="" >Terms of use</Link> and the <Link to="/">Privacy policy</Link></h3>
                        	</div>
                        </div>
                        <div className="row mt_50">
                          <div className="col-md-12">
                            <center><h3 className="dont_have_account">Already have an account? <Link to="/" className="sign_up" >Log In</Link></h3></center>
                          </div>
                        </div>
                      </div>
                    </div>
...
const MyModal=(props)=>{
  ...
  <Modal
    ...
    >
    <Modal.Header>
      <Modal.Title id="contained-modal-title-vcenter" className="mobile_verification">
        Mobile Verification
      </Modal.Title>
    </Modal.Header>
    <Modal.Body>
      ...
      <center>
        ...
        <center>
          <Link to="/"><p className="resend mb_10">Resend</p></Link></center>
        </center>
    </Modal.Body>
    <Modal.Footer>
      <div className="">
        <Button className="close_btn" onClick={props.onHide}>Cancel</Button>
  ...
  <Modal
    ...
    <Modal.Body>
      <center>
        ...
        <p className="please_fill_out_profile">Please fill out your work profile and verify your identity before starting. Thanks!</p>
      </center>
    </Modal.Body>
    <Modal.Footer>
      <div>
        <Button className="my_work_profile_btn" onClick={props1.onHide}>Fill Out My Work Profile</Button>
      </div>
    </Modal.Footer>
  </Modal>
  )
