						...
						<div class="col-md-12">
                        					...
                        					<input type="text" name="" placeholder="Search" required />
                      						<svg class="language_search_icon" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<div class="row mt_30">
														...
														<div class="col-md-6">
															<button class="attach_certificate"><img src={require('../Assets/img/ic_attach.png')} class="attach_icon"></img> Attach Certification</button>											
														</div>
													</div>
                                ...
                                <Form.Select>
                                  <option>Aadhar card</option>
													...
													<div class="row mt_40">
														...
														<div class="col-md-6">
															<button class="attach_certificate"><img src={require('../Assets/img/ic_attach.png')} class="attach_icon"></img> Attach File</button>											
														</div>
													</div>
													<hr className="bottom_border mt_50 mb_50"/>
													<div class="row">
                          ...
                          <div class="row mt_60">
                          	<div className="display_inline">
                            	...
                            	<button class="submit_btn" variant="primary" onClick={()=>setModalShow(true)}>Submit</button>
                            </div>
                          </div>
												</Form>
											</div>
...
const MyModal=(props)=>{
  ...
  <Modal
      ...
      centered
    >
    <Modal.Header class="modal_header" closeButton>
    </Modal.Header>
    <Modal.Body>
      <center>
        <img src={require('../Assets/img/img_success.png')}></img>
        <h3 className="submit_profile">Your Profile Submited Successfully</h3>
        <p className="preferred_schedule">Please choose your preferred Schedule and provide A/C Details to receive Payments from Online Consultation. Thanks!</p>
      </center>     
    </Modal.Body>
    <Modal.Footer>
      <div className="">
        <Button className="set_up_btn" variant="primary"  onClick={props.onHide}>Set up Schedule & Payment</Button>
      </div>
    </Modal.Footer>
  </Modal>
  )
