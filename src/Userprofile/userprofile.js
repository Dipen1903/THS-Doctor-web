                  ...
                  <div class="col-md-12">
                    <div class="basic_info_box">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <span className="skip" onClick={()=>setModalShow(true)}>SKIP</span>
                        </div>
                      </div>
                            ...
                            <div class="col-md-9">
                              <div class="wrapper">
                                <label htmlFor="">
                                  ...
                                  <input type="file" id="upload_avatar" accept="image/png, image/gif, image/jpeg" required />
                                </label>
                              </div>
                              <div class="custom-file-container" data-upload-id="myFirstImage"></div>
                              <p className="upload_avatar_subtitle">Your avatar should is a friendly and inviting head shot. Clearly indentifiable as you.</p>
                            </div>
                          </div>
                          <div class="row mt_20">
                            <div class="col-md-12">
...
const MyModal=(props)=>{
  ...
  <Modal
      ...
      centered
    >
    <Modal.Header className="display_none">
    </Modal.Header>
    <Modal.Body>
      <center>
        <img src={require('../Assets/img/img_skip.png')}></img>
        <h3 className="skip_registration_title">Are you sure you want to skip the registration?</h3>
        <p className="only_verified">Only Verified doctors are allowed to consult on THS Platform.</p>
      </center>     
    </Modal.Body>
    <Modal.Footer>
      <div className="">
        <Button className="close_btn_1" onClick={props.onHide}>Cancel</Button>
        <Button className="skip_btn" variant="primary">Skip Anyway</Button>
      </div>
    </Modal.Footer>
  </Modal>
  )
