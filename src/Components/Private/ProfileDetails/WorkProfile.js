      ...
      <div class="row mt_20">
        <div class="col-md-12">
          ...
          <div class="input_box">
            ...
            <span className="tag_name_box mr_10">
              English <img src={Icon.Cross} class="close_icon"></img>
            </span>
            <span className="tag_name_box">
              Hindi <img src={Icon.Cross} class="close_icon"></img>
            </span>
          </div>
        </div>
      </div>
